                ...
                if (typeof value === 'string' || typeof value === 'number') {
                    ...
                    if ((!format || format.allowCustoms === true) && value.length > 0) {
                        listItems = value.map((v) => {
                            let def = format?.defaults?.find((f) => f.value === (v !== '' ? v : false));
                        ...
                        if (!format || format.type === formatType.select) {
                            ic.push({
                                ...
                                values: listItems.map((x) => {
                                    let icon = x.type === formatValueType.icon
                                        ? x.value === false
                                            ? icons[key]['']
                                    ...
                                    return {
                                        ...
                                        valueOn: x.value,
                                        source: icon,
                                        type: (x.type === formatValueType.icon && icon ? true : false)
                                            ? formatType.icon
                                            : formatType.toggle,
                                    };
                                }),
