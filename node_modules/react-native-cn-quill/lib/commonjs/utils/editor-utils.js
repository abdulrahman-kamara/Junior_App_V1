...
const createHtml = (args = Inital_Args) => {
  ...
  ${(0, _editor.create_quill)(args.editorId, args.toolbar, args.clipboard ? args.clipboard : '', args.placeholder, args.theme, args.fonts.map(f => getFontName(f.name)), args.customJS ? args.customJS : '')}
  ${_editor.editor_js}
  </body>
  </html>
  `;
